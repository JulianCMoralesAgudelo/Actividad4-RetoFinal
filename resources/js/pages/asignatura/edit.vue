    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form @submit.prevent="StoreForm()" action="/asignatura" method="POST">
                        <div class="form-group">
                            <label for="basicInput">Nombre Asignatura</label>
                        ...
                        <div class="form-group">
                            <label for="helpInputTop">Nombre Docente</label>
                        ...
                        <div class="form-group">
                            <label for="helperText">Semestre</label>
                        ...
                        <div class="form-group">
                            <label for="helperText">Materia Prerequisito</label>
                        ...
                        <div class="form-group">
                            <label for="helperText">Horas de trabajo</label><br>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                axios.get('/api/asignatura/' + this.id + '/edit').then((response) => {
            ...
            StoreForm() {
                ...
                axios.put('/api/asignatura/'+ this.id, this.form).then((response) => {
