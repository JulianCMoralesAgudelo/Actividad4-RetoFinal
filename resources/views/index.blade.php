...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/iud.ico') }}" type="image/x-icon">
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                <div class="page-title">
                    ...
                    <p class="text-subtitle text-muted">IU Digital de Antioquia <br> # Somos la primera Institución Universitaria Pública con ADN 100% Digital en Colombia.</p>
                </div>
